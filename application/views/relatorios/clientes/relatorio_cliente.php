	...
	<div class="col-12">
		...
		<div class="card">
			...
			<div class="card-body">
				...
				<h4 class="card-title">Relatório de Clientes</h4>
				<div class="table-responsive m-t-40">
					<table id="table_cliente" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
						<thead>
							<tr>
								<th>Nome</th>
								<th>CPF</th>

...
sessionStorage:localStorage).getItem("DataTables_"+a.sInstance+"_"+location.pathname))}catch(b){}},fnStateLoadParams:null,fnStateLoaded:null,fnStateSaveCallback:function(a,b){try{(-1===a.iStateDuration?sessionStorage:localStorage).setItem("DataTables_"+a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": Ative para ordenação ascendente.",
sSortDescending:": Ative para ordenação descendente."},oPaginate:{sFirst:"Primeiro",sLast:"Ultimo",sNext:"Proximo",sPrevious:"Anterior"},sEmptyTable:"Sem dados disponiveis na tabela.",sInfo:"Exibindo _START_ a _END_ de _TOTAL_ registros",sInfoEmpty:"Exibindo 0 a 0 de 0 entries",sInfoFiltered:"(Filtrado para _MAX_ entradas totais)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Exibir_MENU_ entradas",sLoadingRecords:"Carregando...",sProcessing:"Processando...",sSearch:"Procurar:",sSearchPlaceholder:"Procurar",sUrl:"",sZeroRecords:"Nenhum registro correspondente encontrado."},
